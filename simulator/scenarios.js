// Scenario definitions for the Digital Twin (spec §15).
//
// Ported 1:1 from client/src/services/scenarios.js. This is now the single
// source of truth — the frontend's copy stays as its offline/standalone
// fallback (see client/src/services/api.js's callOrFallback), but whenever
// VITE_USE_BACKEND=true every page gets these definitions via
// GET /api/simulator/status instead.
...
export const SCENARIOS = {
  ...
  rainy: {
    ...
    label: "Heavy Rain",
    emoji: "🌧️",
    description: "Heavy rain significantly reduces solar irradiance and output.",
    dailyMultiplier: 0.45,
    affectedHours: [8, 16],
    dropRange: [0.6, 0.8],
    insight: {
      title: "AI Performance Detective",
      body: "Production is severely impacted by heavy rainfall. While output is low, the rain provides a natural cleaning effect for the panels.",
      tags: ["🌧️ Heavy Rain — primary cause", "⚡ Low Irradiance"],
      severity: "warn",
    },
  },
  heatwave: {
    ...
    emoji: "🔥",
    description: "High temperatures cause thermal degradation of panel efficiency.",
    dailyMultiplier: 0.88,
    affectedHours: [12, 16],
    dropRange: [0.1, 0.2],
    insight: {
      title: "AI Performance Detective",
      body: "High ambient temperatures are causing thermal efficiency losses. Solar panels lose about 0.4% efficiency for every degree above 25°C.",
      tags: ["🔥 Thermal Degradation — likely", "☀️ Clear Sky"],
      severity: "warn",
    },
  },
  shading: {
